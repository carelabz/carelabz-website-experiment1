...
export const ALL_COUNTRIES: Country[] = [
  ...
  { name: "Cocos Islands", iso2: "CC", dialCode: "+61", flag: "🇨🇨" },
  ...
  { name: "Dominican Republic", iso2: "DO", dialCode: "+1849", flag: "🇩🇴" },
  { name: "East Timor", iso2: "TL", dialCode: "+670", flag: "🇹🇱" },
  ...
  { name: "Puerto Rico", iso2: "PR", dialCode: "+1939", flag: "🇵🇷" },
  { name: "Qatar", iso2: "QA", dialCode: "+974", flag: "🇶🇦" },
  { name: "Republic of the Congo", iso2: "CG", dialCode: "+242", flag: "🇨🇬" },
  ...
  { name: "US Virgin Islands", iso2: "VI", dialCode: "+1340", flag: "🇻🇮" },
...
export function getCountryByIso2(iso2: string): Country {
  return (
    ALL_COUNTRIES.find((c) => c.iso2 === iso2) ||
