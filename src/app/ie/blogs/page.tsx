...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs Ireland",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and I.S. 10101:2020 compliance for Ireland facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/ie/blogs/",
    languages: {
      "en-IE": "https://carelabz.com/ie/blogs/",
      "x-default": "https://carelabz.com/ie/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs Ireland",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Ireland.",
    url: "https://carelabz.com/ie/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
export default async function IEBlogIndexPage() {
  const allPosts = await getBlogPosts("ie");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/ie/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs Ireland",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Ireland.",
      "en-IE"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/ie/" },
      { name: "Blog", url: "https://carelabz.com/ie/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of I.S. 10101:2020, I.S. 10101, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help Ireland
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your Ireland facility meet
              I.S. 10101:2020 and I.S. 10101 requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/ie/services/arc-flash-study/"
