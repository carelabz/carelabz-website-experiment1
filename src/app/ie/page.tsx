...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("ie");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | Ireland",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, I.S. 10101:2020 compliance, short circuit analysis, and power system engineering across Ireland.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/ie/",
      languages: {
        "en-IE": "https://carelabz.com/ie/",
        "x-default": "https://carelabz.com/ie/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs Ireland — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, I.S. 10101:2020 compliance, and power system engineering across Ireland.",
      url: "https://carelabz.com/ie/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_IE",
    },
...
export default async function IEHomePage() {
  const page = await getHomePage("ie");
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, Ireland",
    },
  };
      ...
      <section className="bg-[#EEF4FF] py-16 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-[#374151] max-w-3xl mx-auto">
            At Carelabs, we understand the importance of identifying risks and mitigating them to enhance the performance and safety of your power system and your people. We are committed to ensuring that your power system is compliant with Ireland standards of electrical safety by integrating technical expertise with high-end tools like ETAP.
          </p>
        </div>
      </section>
