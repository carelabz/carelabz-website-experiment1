...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getAboutPage("fr");
  return {
    title: page?.metaTitle ?? "About Carelabs | France Electrical Safety Experts",
    description:
      page?.metaDescription ??
      "Learn about Carelabs — our mission, values, and the team dedicated to electrical safety testing and NF C 15-100 compliance across France.",
    alternates: {
      canonical: "https://carelabz.com/fr/about-us/",
      languages: {
        "en-FR": "https://carelabz.com/fr/about-us/",
        "x-default": "https://carelabz.com/fr/about-us/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "About Carelabs — Power System Consultants France",
      description:
        page?.metaDescription ?? "Carelabs is a leading electrical safety engineering firm in France.",
      url: "https://carelabz.com/fr/about-us/",
      siteName: "Carelabs",
      type: "website",
    },
    twitter: {
...
export default async function FRAboutPage() {
  ...
  const subtext =
    page?.heroSubtext ??
    "Carelabs is a trusted partner for electrical safety testing, calibration, inspection, and certification services across France.";
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/fr/about-us/",
      page?.metaTitle ?? "About Carelabs — Power System Consultants France",
      page?.metaDescription ?? "Carelabs is a leading electrical safety engineering firm in France.",
      "en-FR"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/fr/" },
      { name: "About", url: "https://carelabz.com/fr/about-us/" },
    ]),
  ]);
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              {page?.ctaBannerHeading ?? "Partner with Carelabs France"}
            </h2>
            {page?.ctaBannerSubtext ? (
              <p className="text-white/70 text-lg mb-8">{page.ctaBannerSubtext}</p>
            ) : (
              <p className="text-white/70 text-lg mb-8">
                Ready to elevate your safety standards? Talk to our France experts today.
              </p>
            )}
            <Link
              href={page?.ctaBannerPrimaryHref ?? "/fr/contact-us/"}
