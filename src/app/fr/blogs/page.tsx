...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs France",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and NF C 15-100 compliance for France facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/fr/blogs/",
    languages: {
      "en-FR": "https://carelabz.com/fr/blogs/",
      "x-default": "https://carelabz.com/fr/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs France",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in France.",
    url: "https://carelabz.com/fr/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
export default async function FRBlogIndexPage() {
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/fr/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs France",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in France.",
      "en-FR"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/fr/" },
      { name: "Blog", url: "https://carelabz.com/fr/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of NF C 15-100, NF C 15-100, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help France
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your France facility meet
              NF C 15-100 and NF C 15-100 requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/fr/services/arc-flash-study/"
