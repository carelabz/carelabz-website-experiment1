...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("fr");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | France",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, NF C 15-100 compliance, short circuit analysis, and power system engineering across France.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/fr/",
      languages: {
        "en-FR": "https://carelabz.com/fr/",
        "x-default": "https://carelabz.com/fr/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs France — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, NF C 15-100 compliance, and power system engineering across France.",
      url: "https://carelabz.com/fr/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_FR",
    },
...
export default async function FRHomePage() {
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, France",
    },
  };
      ...
      <section className="bg-[#EEF4FF] py-16 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-[#374151] max-w-3xl mx-auto">
            At Carelabs, we understand the importance of identifying risks and mitigating them to enhance the performance and safety of your power system and your people. We are committed to ensuring that your power system is compliant with France standards of electrical safety by integrating technical expertise with high-end tools like ETAP.
          </p>
        </div>
      </section>
