...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        "en-CA": "https://carelabz.com/ca/",
        "x-default": "https://carelabz.com/ca/",
      },
    },
    openGraph: {
...
export default async function CAHomePage() {
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, Canada",
    },
  };
    ...
    <>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            ...
            <div>
              ...
              <p className="text-blue-100">Compliance with CSA Z462, IEEE, and CEC</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white py-12 px-4">
        <div className="mx-auto max-w-5xl">
          <div className="flex flex-wrap justify-center gap-4">
            {["CSA Z462", "IEEE 1584", "Canadian Electrical Code", "P.Eng Certified", "ETAP Certified"].map((cert) => (
