...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        "en-CA": "https://carelabz.com/ca/about-us/",
        "x-default": "https://carelabz.com/ca/about-us/",
      },
    },
    openGraph: {
...
export default async function CAAboutPage() {
  const page = await getAboutPage("ca");
  ...
  const jsonLd = buildJsonLd([
    ...
    getBreadcrumbSchema([
      ...
      { name: "About", url: "https://carelabz.com/ca/about-us/" },
    ]),
  ]);
          ...
          <div className="mx-auto max-w-4xl text-center">
            ...
            {page?.ctaBannerSubtext ? (
              ...
              <p className="text-white/70 text-lg mb-8">
                Ready to elevate your safety standards? Talk to our Canadian experts today.
              </p>
            )}
            <Link
              href={page?.ctaBannerPrimaryHref ?? "/ca/contact/"}
