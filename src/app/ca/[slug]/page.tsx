...
export async function generateMetadata({
  ...
  const post = await getBlogPost("ca", params.slug);
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        "en-CA": `https://carelabz.com/ca/${params.slug}/`,
        "x-default": `https://carelabz.com/ca/${params.slug}/`,
      },
    },
    openGraph: {
      title: post.metaTitle ?? `${post.title} | Carelabs Canada`,
...
export default async function CABlogPostPage({ params }: PageProps) {
  ...
  const articleJsonLd = {
    ...
    ...(post.heroImage
      ...
      : {}),
    url: `https://carelabz.com/ca/${post.slug}/`,
  };
      ...
      <main id="main-content">
        <section className="bg-[#EEF4FF] pt-28 pb-16 px-4">
          <div className="mx-auto max-w-4xl">
            ...
            >
              <Link href="/ca/" className="hover:text-[#1A2538] transition-colors">
                Home
              </Link>
