...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        "en-CA": "https://carelabz.com/ca/contact/",
        "x-default": "https://carelabz.com/ca/contact/",
      },
    },
    openGraph: {
...
export default async function CAContactPage() {
  ...
  const subtext =
    page?.heroSubtext ??
    "Have a question or ready to start a project? Our Canadian team is here to help.";
  ...
  const jsonLd = buildJsonLd([
    ...
    getBreadcrumbSchema([
      ...
      { name: "Contact", url: "https://carelabz.com/ca/contact/" },
    ]),
  ]);
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8">
              Our Canadian team is available to respond to emergency compliance and
