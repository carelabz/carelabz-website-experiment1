...
interface CAServicePageProps {
  params: { slug: string };
}

export async function generateMetadata({
  params,
}: CAServicePageProps): Promise<Metadata> {
  const strapiSlug = `${params.slug}-ca`;
...
function buildPageData(service: ServicePage) {
  return {
    ...
    trustBadges: service.trustBadges || [
      { label: "CSA Z462" },
      { label: "Canadian Electrical Code" },
      { label: "IEEE 1584" },
    ...
    safetyBody:
      service.safetyBody ||
      "Electrical hazards are among the leading causes of workplace injuries in Canadian facilities.",
    ...
    reportsBody:
      service.reportsBody ||
      "Every engagement concludes with a detailed CSA Z462-aligned report package.",
        ...
        itemListElement: [
          {
            ...
            position: 1,
            name: "Home",
            item: "https://carelabz.com/ca/",
          },
          {
            "@type": "ListItem",
            position: 2,
            name: "Services",
            item: "https://carelabz.com/ca/service/",
          },
          {
            "@type": "ListItem",
            position: 3,
      ...
      <section className="bg-[#EEF4FF] py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { name: "Oil & Gas", desc: "Upstream, midstream, and downstream facilities across Canada" },
