...
export const metadata: Metadata = {
  ...
  description:
    "Carelabs Canadian electrical safety services — arc flash studies, short circuit analysis, load flow analysis, and relay coordination aligned with CSA Z462 and the Canadian Electrical Code.",
  alternates: {
    canonical: "https://carelabz.com/ca/services/",
    languages: {
      "en-CA": "https://carelabz.com/ca/services/",
      "x-default": "https://carelabz.com/ca/services/",
    },
  },
  openGraph: {
    ...
    url: "https://carelabz.com/ca/services/",
    siteName: "Carelabs",
    type: "website",
    locale: "en_CA",
  },
...
function getServiceHref(service: ServicePage): string {
  const slug = service.slug.endsWith("-ca")
    ? service.slug.slice(0, -3)
    : service.slug;
  return `/ca/services/${slug}/`;
}

export default async function CAServicesIndexPage() {
  const services = await getServicesByRegion("ca");

  const jsonLd = buildJsonLd([
    getOrganizationSchemaCA(),
    getWebPageSchema(
      "https://carelabz.com/ca/services/",
    ...
    getBreadcrumbSchema([
      ...
      { name: "Services", url: "https://carelabz.com/ca/services/" },
    ]),
  ]);
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="text-lg text-[#374151] leading-relaxed">
              ...
              facilities compliant with CSA Z462 and the Canadian Electrical Code,
              your workers protected, and your operations running smoothly —
              delivered by certified engineers across Canada.
            </p>
          </div>
        </div>
      </section>
