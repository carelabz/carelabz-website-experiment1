...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: {
      "en-CA": "https://carelabz.com/ca/service/",
      "x-default": "https://carelabz.com/ca/service/",
    },
  },
  openGraph: {
...
export default async function CAServicesIndexPage() {
  ...
  const jsonLd = buildJsonLd([
    ...
    getBreadcrumbSchema([
      ...
      { name: "Services", url: "https://carelabz.com/ca/service/" },
    ]),
  ]);
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="text-lg text-[#374151] leading-relaxed">
              ...
              facilities compliant with CSA Z462, your workers protected, and
              your operations running smoothly — delivered by certified engineers across Canada.
            </p>
          </div>
        </div>
      </section>
