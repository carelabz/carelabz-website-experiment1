...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs New Zealand",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and AS/NZS 3000 compliance for New Zealand facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/nz/blogs/",
    languages: {
      "en-NZ": "https://carelabz.com/nz/blogs/",
      "x-default": "https://carelabz.com/nz/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs New Zealand",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in New Zealand.",
    url: "https://carelabz.com/nz/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
export default async function NZBlogIndexPage() {
  const allPosts = await getBlogPosts("nz");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/nz/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs New Zealand",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in New Zealand.",
      "en-NZ"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/nz/" },
      { name: "Blog", url: "https://carelabz.com/nz/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of AS/NZS 3000, AS/NZS 3000, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help New Zealand
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your New Zealand facility meet
              AS/NZS 3000 and AS/NZS 3000 requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/nz/services/arc-flash-study/"
