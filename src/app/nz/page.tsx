...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("nz");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | New Zealand",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, AS/NZS 3000 compliance, short circuit analysis, and power system engineering across New Zealand.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/nz/",
      languages: {
        "en-NZ": "https://carelabz.com/nz/",
        "x-default": "https://carelabz.com/nz/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs New Zealand — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, AS/NZS 3000 compliance, and power system engineering across New Zealand.",
      url: "https://carelabz.com/nz/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_NZ",
    },
...
export default async function NZHomePage() {
  const page = await getHomePage("nz");
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, New Zealand",
    },
  };
      ...
      <section className="bg-[#EEF4FF] py-16 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-[#374151] max-w-3xl mx-auto">
            At Carelabs, we understand the importance of identifying risks and mitigating them to enhance the performance and safety of your power system and your people. We are committed to ensuring that your power system is compliant with New Zealand standards of electrical safety by integrating technical expertise with high-end tools like ETAP.
          </p>
        </div>
      </section>
