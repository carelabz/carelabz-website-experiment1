...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("hk");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | Hong Kong",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, CoP Electrical Installation compliance, short circuit analysis, and power system engineering across Hong Kong.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/hk/",
      languages: {
        "en-HK": "https://carelabz.com/hk/",
        "x-default": "https://carelabz.com/hk/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs Hong Kong — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, CoP Electrical Installation compliance, and power system engineering across Hong Kong.",
      url: "https://carelabz.com/hk/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_HK",
    },
...
export default async function HKHomePage() {
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, Hong Kong",
    },
  };
      ...
      <section className="bg-[#EEF4FF] py-16 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-[#374151] max-w-3xl mx-auto">
            At Carelabs, we understand the importance of identifying risks and mitigating them to enhance the performance and safety of your power system and your people. We are committed to ensuring that your power system is compliant with Hong Kong standards of electrical safety by integrating technical expertise with high-end tools like ETAP.
          </p>
        </div>
      </section>
