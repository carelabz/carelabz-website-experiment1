...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs Hong Kong",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and CoP Electrical Installation compliance for Hong Kong facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/hk/blogs/",
    languages: {
      "en-HK": "https://carelabz.com/hk/blogs/",
      "x-default": "https://carelabz.com/hk/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs Hong Kong",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Hong Kong.",
    url: "https://carelabz.com/hk/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
export default async function HKBlogIndexPage() {
  const allPosts = await getBlogPosts("hk");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/hk/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs Hong Kong",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Hong Kong.",
      "en-HK"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/hk/" },
      { name: "Blog", url: "https://carelabz.com/hk/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of CoP Electrical Installation, CoP, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help Hong Kong
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your Hong Kong facility meet
              CoP Electrical Installation and CoP requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/hk/services/arc-flash-study/"
