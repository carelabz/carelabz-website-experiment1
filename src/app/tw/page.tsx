...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("tw");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | Taiwan",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, User Electricity Supply Regulations compliance, short circuit analysis, and power system engineering across Taiwan.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/tw/",
      languages: {
        "en-TW": "https://carelabz.com/tw/",
        "x-default": "https://carelabz.com/tw/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs Taiwan — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, User Electricity Supply Regulations compliance, and power system engineering across Taiwan.",
      url: "https://carelabz.com/tw/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_TW",
    },
...
export default async function TWHomePage() {
  const page = await getHomePage("tw");
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, Taiwan",
    },
  };
      ...
      <section className="bg-[#EEF4FF] py-16 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-[#374151] max-w-3xl mx-auto">
            At Carelabs, we understand the importance of identifying risks and mitigating them to enhance the performance and safety of your power system and your people. We are committed to ensuring that your power system is compliant with Taiwan standards of electrical safety by integrating technical expertise with high-end tools like ETAP.
          </p>
        </div>
      </section>
