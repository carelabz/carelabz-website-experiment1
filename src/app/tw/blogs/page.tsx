...
const config = COUNTRY_CONFIGS["tw"];
...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs Taiwan",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and User Electricity Supply Regulations compliance for Taiwan facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/tw/blogs/",
    languages: {
      "en-TW": "https://carelabz.com/tw/blogs/",
      "x-default": "https://carelabz.com/tw/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs Taiwan",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Taiwan.",
    url: "https://carelabz.com/tw/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
function formatDateShort(dateString: string | null): string {
  ...
  try {
    return new Date(dateString).toLocaleDateString("en-TW", {
      day: "numeric",
      month: "short",
      year: "numeric",
    });
...
export default async function TWBlogIndexPage() {
  const allPosts = await getBlogPosts("tw");
  ...
  const jsonLd = buildJsonLd([
    getRegionOrganizationSchema({ cc: "tw", countryName: "Taiwan", countryIso2: "TW", phone: config.phone, email: config.email, addressLocality: config.address }),
    getWebPageSchema(
      "https://carelabz.com/tw/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs Taiwan",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Taiwan.",
      "en-TW"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/tw/" },
      { name: "Blog", url: "https://carelabz.com/tw/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of User Electricity Supply Regulations, CNS 60364, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help Taiwan
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your Taiwan facility meet
              User Electricity Supply Regulations and CNS 60364 requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/tw/services/arc-flash-study/"
