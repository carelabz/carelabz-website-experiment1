...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs Sweden",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and EBR 18:2017 compliance for Sweden facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/se/blogs/",
    languages: {
      "en-SE": "https://carelabz.com/se/blogs/",
      "x-default": "https://carelabz.com/se/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs Sweden",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Sweden.",
    url: "https://carelabz.com/se/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
export default async function SEBlogIndexPage() {
  const allPosts = await getBlogPosts("se");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/se/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs Sweden",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Sweden.",
      "en-SE"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/se/" },
      { name: "Blog", url: "https://carelabz.com/se/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of EBR 18:2017, SS-EN 60364, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help Sweden
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your Sweden facility meet
              EBR 18:2017 and SS-EN 60364 requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/se/services/arc-flash-study/"
