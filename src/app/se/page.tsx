...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("se");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | Sweden",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, EBR 18:2017 compliance, short circuit analysis, and power system engineering across Sweden.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/se/",
      languages: {
        "en-SE": "https://carelabz.com/se/",
        "x-default": "https://carelabz.com/se/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs Sweden — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, EBR 18:2017 compliance, and power system engineering across Sweden.",
      url: "https://carelabz.com/se/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_SE",
    },
...
export default async function SEHomePage() {
  const page = await getHomePage("se");
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, Sweden",
    },
  };
      ...
      <section className="bg-[#EEF4FF] py-16 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-[#374151] max-w-3xl mx-auto">
            At Carelabs, we understand the importance of identifying risks and mitigating them to enhance the performance and safety of your power system and your people. We are committed to ensuring that your power system is compliant with Sweden standards of electrical safety by integrating technical expertise with high-end tools like ETAP.
          </p>
        </div>
      </section>
