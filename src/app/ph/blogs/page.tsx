...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs Philippines",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and Philippine Electrical Code compliance for Philippines facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/ph/blogs/",
    languages: {
      "en-PH": "https://carelabz.com/ph/blogs/",
      "x-default": "https://carelabz.com/ph/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs Philippines",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Philippines.",
    url: "https://carelabz.com/ph/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
export default async function PHBlogIndexPage() {
  const allPosts = await getBlogPosts("ph");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/ph/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs Philippines",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Philippines.",
      "en-PH"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/ph/" },
      { name: "Blog", url: "https://carelabz.com/ph/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of Philippine Electrical Code, PEC, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help Philippines
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your Philippines facility meet
              Philippine Electrical Code and PEC requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/ph/services/arc-flash-study/"
