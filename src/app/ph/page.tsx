...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("ph");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | Philippines",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, Philippine Electrical Code compliance, short circuit analysis, and power system engineering across Philippines.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/ph/",
      languages: {
        "en-PH": "https://carelabz.com/ph/",
        "x-default": "https://carelabz.com/ph/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs Philippines — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, Philippine Electrical Code compliance, and power system engineering across Philippines.",
      url: "https://carelabz.com/ph/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_PH",
    },
...
export default async function PHHomePage() {
  const page = await getHomePage("ph");
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, Philippines",
    },
  };
      ...
      <section className="bg-[#EEF4FF] py-16 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-[#374151] max-w-3xl mx-auto">
            At Carelabs, we understand the importance of identifying risks and mitigating them to enhance the performance and safety of your power system and your people. We are committed to ensuring that your power system is compliant with Philippines standards of electrical safety by integrating technical expertise with high-end tools like ETAP.
          </p>
        </div>
      </section>
