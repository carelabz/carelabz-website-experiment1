...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("nl");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | Netherlands",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, NEN 1010 compliance, short circuit analysis, and power system engineering across Netherlands.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/nl/",
      languages: {
        "en-NL": "https://carelabz.com/nl/",
        "x-default": "https://carelabz.com/nl/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs Netherlands — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, NEN 1010 compliance, and power system engineering across Netherlands.",
      url: "https://carelabz.com/nl/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_NL",
    },
...
export default async function NLHomePage() {
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, Netherlands",
    },
  };
      ...
      <section className="bg-[#EEF4FF] py-16 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-[#374151] max-w-3xl mx-auto">
            At Carelabs, we understand the importance of identifying risks and mitigating them to enhance the performance and safety of your power system and your people. We are committed to ensuring that your power system is compliant with Netherlands standards of electrical safety by integrating technical expertise with high-end tools like ETAP.
          </p>
        </div>
      </section>
