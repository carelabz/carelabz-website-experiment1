...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs Netherlands",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and NEN 1010 compliance for Netherlands facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/nl/blogs/",
    languages: {
      "en-NL": "https://carelabz.com/nl/blogs/",
      "x-default": "https://carelabz.com/nl/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs Netherlands",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Netherlands.",
    url: "https://carelabz.com/nl/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
export default async function NLBlogIndexPage() {
  const allPosts = await getBlogPosts("nl");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/nl/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs Netherlands",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Netherlands.",
      "en-NL"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/nl/" },
      { name: "Blog", url: "https://carelabz.com/nl/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of NEN 1010, NEN 1010, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help Netherlands
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your Netherlands facility meet
              NEN 1010 and NEN 1010 requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/nl/services/arc-flash-study/"
