...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs Russia",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and PUE-7 compliance for Russia facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/ru/blogs/",
    languages: {
      "en-RU": "https://carelabz.com/ru/blogs/",
      "x-default": "https://carelabz.com/ru/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs Russia",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Russia.",
    url: "https://carelabz.com/ru/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
function formatDateShort(dateString: string | null): string {
  ...
  try {
    return new Date(dateString).toLocaleDateString("en-RU", {
      day: "numeric",
      month: "short",
      year: "numeric",
    });
...
export default async function RUBlogIndexPage() {
  const allPosts = await getBlogPosts("ru");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/ru/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs Russia",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Russia.",
      "en-RU"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/ru/" },
      { name: "Blog", url: "https://carelabz.com/ru/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of PUE-7, PUE-7, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help Russian
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your Russia facility meet
              PUE-7 and PUE-7 requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/ru/services/arc-flash-study/"
