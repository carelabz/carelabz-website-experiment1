...
export const metadata: Metadata = {
  title: "Electrical Safety Services Russia | Carelabs",
  description:
    "Discover Carelabs' Russian electrical safety services — arc flash studies, short circuit analysis, load flow analysis, and relay coordination aligned with PUE-7 and the PUE-7.",
  alternates: {
    canonical: "https://carelabz.com/ru/our-services/",
    languages: {
      "en-RU": "https://carelabz.com/ru/our-services/",
      "x-default": "https://carelabz.com/ru/our-services/",
    },
  },
  openGraph: {
    title: "Power System Engineering Services in Russia | Carelabs",
    description:
      "Professional electrical safety services including arc flash studies, short circuit analysis, and power system engineering across Russia.",
    url: "https://carelabz.com/ru/our-services/",
    siteName: "Carelabs",
    type: "website",
    locale: "en_RU",
  },
...
export default async function RUServicesIndexPage() {
  const services = await getServicesByRegion("ru");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/ru/our-services/",
      "Power System Engineering Services in Russia | Carelabs",
      "Professional electrical safety services including arc flash studies, short circuit analysis, and power system engineering across Russia.",
      "en-RU"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/ru/" },
      { name: "Services", url: "https://carelabz.com/ru/our-services/" },
    ]),
  ]);
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="text-lg text-[#374151] leading-relaxed">
              ...
              facilities compliant with PUE-7, your workers protected, and
              your operations running smoothly — delivered by certified engineers across Russia.
            </p>
          </div>
        </div>
      </section>
