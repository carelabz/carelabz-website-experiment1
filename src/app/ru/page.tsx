...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("ru");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | Russia",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, PUE-7 compliance, short circuit analysis, and power system engineering across Russia.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/ru/",
      languages: {
        "en-RU": "https://carelabz.com/ru/",
        "x-default": "https://carelabz.com/ru/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs Russia — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, PUE-7 compliance, and power system engineering across Russia.",
      url: "https://carelabz.com/ru/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_RU",
    },
...
export default async function RUHomePage() {
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, Russia",
    },
  };
      ...
      <section className="bg-[#EEF4FF] py-16 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-[#374151] max-w-3xl mx-auto">
            At Carelabs, we understand the importance of identifying risks and mitigating them to enhance the performance and safety of your power system and your people. We are committed to ensuring that your power system is compliant with Russian standards of electrical safety by integrating technical expertise with high-end tools like ETAP.
          </p>
        </div>
      </section>
