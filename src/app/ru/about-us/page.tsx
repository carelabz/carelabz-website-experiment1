...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getAboutPage("ru");
  return {
    title: page?.metaTitle ?? "About Carelabs | Russian Electrical Safety Experts",
    description:
      page?.metaDescription ??
      "Learn about Carelabs — our mission, values, and the team dedicated to electrical safety testing and PUE-7 compliance across Russia.",
    alternates: {
      canonical: "https://carelabz.com/ru/about-us/",
      languages: {
        "en-RU": "https://carelabz.com/ru/about-us/",
        "x-default": "https://carelabz.com/ru/about-us/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "About Carelabs — Power System Consultants Russia",
      description:
        page?.metaDescription ?? "Carelabs is a leading electrical safety engineering firm in Russia.",
      url: "https://carelabz.com/ru/about-us/",
      siteName: "Carelabs",
      type: "website",
    },
    twitter: {
...
export default async function RUAboutPage() {
  ...
  const subtext =
    page?.heroSubtext ??
    "Carelabs is a trusted partner for electrical safety testing, calibration, inspection, and certification services across Russia.";
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/ru/about-us/",
      page?.metaTitle ?? "About Carelabs — Power System Consultants Russia",
      page?.metaDescription ?? "Carelabs is a leading electrical safety engineering firm in Russia.",
      "en-RU"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/ru/" },
      { name: "About", url: "https://carelabz.com/ru/about-us/" },
    ]),
  ]);
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              {page?.ctaBannerHeading ?? "Partner with Carelabs Russia"}
            </h2>
            {page?.ctaBannerSubtext ? (
              <p className="text-white/70 text-lg mb-8">{page.ctaBannerSubtext}</p>
            ) : (
              <p className="text-white/70 text-lg mb-8">
                Ready to elevate your safety standards? Talk to our Russian experts today.
              </p>
            )}
            <Link
              href={page?.ctaBannerPrimaryHref ?? "/ru/contact-us/"}
