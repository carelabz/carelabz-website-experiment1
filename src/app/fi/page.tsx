...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("fi");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | Finland",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, SFS 6000 compliance, short circuit analysis, and power system engineering across Finland.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/fi/",
      languages: {
        "en-FI": "https://carelabz.com/fi/",
        "x-default": "https://carelabz.com/fi/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs Finland — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, SFS 6000 compliance, and power system engineering across Finland.",
      url: "https://carelabz.com/fi/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_FI",
    },
...
export default async function FIHomePage() {
  const page = await getHomePage("fi");
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, Finland",
    },
  };
      ...
      <section className="bg-[#EEF4FF] py-16 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-[#374151] max-w-3xl mx-auto">
            At Carelabs, we understand the importance of identifying risks and mitigating them to enhance the performance and safety of your power system and your people. We are committed to ensuring that your power system is compliant with Finland standards of electrical safety by integrating technical expertise with high-end tools like ETAP.
          </p>
        </div>
      </section>
