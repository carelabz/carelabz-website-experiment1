...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs Finland",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and SFS 6000 compliance for Finland facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/fi/blogs/",
    languages: {
      "en-FI": "https://carelabz.com/fi/blogs/",
      "x-default": "https://carelabz.com/fi/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs Finland",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Finland.",
    url: "https://carelabz.com/fi/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
function formatDateShort(dateString: string | null): string {
  ...
  try {
    return new Date(dateString).toLocaleDateString("en-FI", {
      day: "numeric",
      month: "short",
      year: "numeric",
    });
...
export default async function FIBlogIndexPage() {
  const allPosts = await getBlogPosts("fi");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/fi/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs Finland",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Finland.",
      "en-FI"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/fi/" },
      { name: "Blog", url: "https://carelabz.com/fi/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of SFS 6000, SFS 6000, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help Finland
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your Finland facility meet
              SFS 6000 and SFS 6000 requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/fi/services/arc-flash-study/"
