...
export const metadata: Metadata = {
  title: "Electrical Safety Services Peru | Carelabs",
  description:
    "Discover Carelabs' Peru electrical safety services — arc flash studies, short circuit analysis, load flow analysis, and relay coordination aligned with RM 111-2013-MEM and the CNE.",
  alternates: {
    canonical: "https://carelabz.com/pe/service/",
    languages: {
      "en-PE": "https://carelabz.com/pe/service/",
      "x-default": "https://carelabz.com/pe/service/",
    },
  },
  openGraph: {
    title: "Power System Engineering Services in Peru | Carelabs",
    description:
      "Professional electrical safety services including arc flash studies, short circuit analysis, and power system engineering across Peru.",
    url: "https://carelabz.com/pe/service/",
    siteName: "Carelabs",
    type: "website",
    locale: "en_PE",
  },
...
function getServiceHref(service: ServicePage): string {
  ...
  return `/pe/services/${urlSlug}/`;
}

export default async function PEServicesIndexPage() {
  const services = await getServicesByRegion("pe");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/pe/service/",
      "Power System Engineering Services in Peru | Carelabs",
      "Professional electrical safety services including arc flash studies, short circuit analysis, and power system engineering across Peru.",
      "en-PE"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/pe/" },
      { name: "Services", url: "https://carelabz.com/pe/service/" },
    ]),
  ]);
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="text-lg text-[#374151] leading-relaxed">
              ...
              facilities compliant with RM 111-2013-MEM, your workers protected, and
              your operations running smoothly — delivered by certified engineers across Peru.
            </p>
          </div>
        </div>
      </section>
