...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getAboutPage("pe");
  return {
    title: page?.metaTitle ?? "About Carelabs | Peru Electrical Safety Experts",
    description:
      page?.metaDescription ??
      "Learn about Carelabs — our mission, values, and the team dedicated to electrical safety testing and RM 111-2013-MEM compliance across Peru.",
    alternates: {
      canonical: "https://carelabz.com/pe/about-us/",
      languages: {
        "en-PE": "https://carelabz.com/pe/about-us/",
        "x-default": "https://carelabz.com/pe/about-us/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "About Carelabs — Power System Consultants Peru",
      description:
        page?.metaDescription ?? "Carelabs is a leading electrical safety engineering firm in Peru.",
      url: "https://carelabz.com/pe/about-us/",
      siteName: "Carelabs",
      type: "website",
    },
    twitter: {
...
export default async function PEAboutPage() {
  ...
  const subtext =
    page?.heroSubtext ??
    "Carelabs is a trusted partner for electrical safety testing, calibration, inspection, and certification services across Peru.";
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/pe/about-us/",
      page?.metaTitle ?? "About Carelabs — Power System Consultants Peru",
      page?.metaDescription ?? "Carelabs is a leading electrical safety engineering firm in Peru.",
      "en-PE"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/pe/" },
      { name: "About", url: "https://carelabz.com/pe/about-us/" },
    ]),
  ]);
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              {page?.ctaBannerHeading ?? "Partner with Carelabs Peru"}
            </h2>
            {page?.ctaBannerSubtext ? (
              <p className="text-white/70 text-lg mb-8">{page.ctaBannerSubtext}</p>
            ) : (
              <p className="text-white/70 text-lg mb-8">
                Ready to elevate your safety standards? Talk to our Peru experts today.
              </p>
            )}
            <Link
              href={page?.ctaBannerPrimaryHref ?? "/pe/contact-us/"}
