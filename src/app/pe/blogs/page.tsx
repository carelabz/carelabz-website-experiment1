...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://carelabz.com/pe/blogs/",
    languages: {
      "en-PE": "https://carelabz.com/pe/blogs/",
      "x-default": "https://carelabz.com/pe/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs Peru",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Peru.",
    url: "https://carelabz.com/pe/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
function formatDateShort(dateString: string | null): string {
  ...
  try {
    return new Date(dateString).toLocaleDateString("en-PE", {
      day: "numeric",
      month: "short",
      year: "numeric",
    });
...
export default async function PEBlogIndexPage() {
  ...
  const jsonLd = buildJsonLd([
    ...
    getBreadcrumbSchema([
      ...
      { name: "Blog", url: "https://carelabz.com/pe/blogs/" },
    ]),
  ]);
