...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs Slovakia",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and STN 33 2000 compliance for Slovakia facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/sk/blogs/",
    languages: {
      "en-SK": "https://carelabz.com/sk/blogs/",
      "x-default": "https://carelabz.com/sk/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs Slovakia",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Slovakia.",
    url: "https://carelabz.com/sk/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
function formatDateShort(dateString: string | null): string {
  ...
  try {
    return new Date(dateString).toLocaleDateString("en-SK", {
      day: "numeric",
      month: "short",
      year: "numeric",
    });
...
export default async function SKBlogIndexPage() {
  const allPosts = await getBlogPosts("sk");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/sk/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs Slovakia",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Slovakia.",
      "en-SK"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/sk/" },
      { name: "Blog", url: "https://carelabz.com/sk/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of STN 33 2000, STN 33 2000, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help Slovakian
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your Slovakia facility meet
              STN 33 2000 and STN 33 2000 requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/sk/services/arc-flash-study/"
