...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("sk");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | Slovakia",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, STN 33 2000 compliance, short circuit analysis, and power system engineering across Slovakia.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/sk/",
      languages: {
        "en-SK": "https://carelabz.com/sk/",
        "x-default": "https://carelabz.com/sk/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs Slovakia — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, STN 33 2000 compliance, and power system engineering across Slovakia.",
      url: "https://carelabz.com/sk/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_SK",
    },
...
export default async function SKHomePage() {
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, Slovakia",
    },
  };
      ...
      <section className="bg-[#EEF4FF] py-16 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-[#374151] max-w-3xl mx-auto">
            At Carelabs, we understand the importance of identifying risks and mitigating them to enhance the performance and safety of your power system and your people. We are committed to ensuring that your power system is compliant with Slovakian standards of electrical safety by integrating technical expertise with high-end tools like ETAP.
          </p>
        </div>
      </section>
