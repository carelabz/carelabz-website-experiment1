...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("pt");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | Portugal",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, RTIEBT compliance, short circuit analysis, and power system engineering across Portugal.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/pt/",
      languages: {
        "en-PT": "https://carelabz.com/pt/",
        "x-default": "https://carelabz.com/pt/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs Portugal — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, RTIEBT compliance, and power system engineering across Portugal.",
      url: "https://carelabz.com/pt/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_PT",
    },
...
export default async function PTHomePage() {
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, Portugal",
    },
  };
      ...
      <section className="bg-[#EEF4FF] py-16 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-[#374151] max-w-3xl mx-auto">
            At Carelabs, we understand the importance of identifying risks and mitigating them to enhance the performance and safety of your power system and your people. We are committed to ensuring that your power system is compliant with Portugal standards of electrical safety by integrating technical expertise with high-end tools like ETAP.
          </p>
        </div>
      </section>
