...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs Portugal",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and RTIEBT compliance for Portugal facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/pt/blogs/",
    languages: {
      "en-PT": "https://carelabz.com/pt/blogs/",
      "x-default": "https://carelabz.com/pt/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs Portugal",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Portugal.",
    url: "https://carelabz.com/pt/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
function formatDateShort(dateString: string | null): string {
  ...
  try {
    return new Date(dateString).toLocaleDateString("en-PT", {
      day: "numeric",
      month: "short",
      year: "numeric",
    });
...
export default async function PTBlogIndexPage() {
  const allPosts = await getBlogPosts("pt");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/pt/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs Portugal",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Portugal.",
      "en-PT"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/pt/" },
      { name: "Blog", url: "https://carelabz.com/pt/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of RTIEBT, RTIEBT, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help Portugal
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your Portugal facility meet
              RTIEBT and RTIEBT requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/pt/services/arc-flash-study/"
