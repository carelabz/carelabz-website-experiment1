...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("dk");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | Denmark",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, DS/HD 60364 compliance, short circuit analysis, and power system engineering across Denmark.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/dk/",
      languages: {
        "en-DK": "https://carelabz.com/dk/",
        "x-default": "https://carelabz.com/dk/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs Denmark — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, DS/HD 60364 compliance, and power system engineering across Denmark.",
      url: "https://carelabz.com/dk/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_DK",
    },
...
export default async function DKHomePage() {
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, Denmark",
    },
  };
      ...
      <section className="bg-[#EEF4FF] py-16 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-[#374151] max-w-3xl mx-auto">
            At Carelabs, we understand the importance of identifying risks and mitigating them to enhance the performance and safety of your power system and your people. We are committed to ensuring that your power system is compliant with Denmark standards of electrical safety by integrating technical expertise with high-end tools like ETAP.
          </p>
        </div>
      </section>
