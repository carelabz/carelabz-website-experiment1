...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("ch");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | Switzerland",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, NIN (SEV 1000) compliance, short circuit analysis, and power system engineering across Switzerland.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/ch/",
      languages: {
        "en-CH": "https://carelabz.com/ch/",
        "x-default": "https://carelabz.com/ch/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs Switzerland — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, NIN (SEV 1000) compliance, and power system engineering across Switzerland.",
      url: "https://carelabz.com/ch/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_CH",
    },
...
export default async function CHHomePage() {
  const page = await getHomePage("ch");
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, Switzerland",
    },
  };
      ...
      <section className="bg-[#EEF4FF] py-16 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-[#374151] max-w-3xl mx-auto">
            At Carelabs, we understand the importance of identifying risks and mitigating them to enhance the performance and safety of your power system and your people. We are committed to ensuring that your power system is compliant with Switzerland standards of electrical safety by integrating technical expertise with high-end tools like ETAP.
          </p>
        </div>
      </section>
