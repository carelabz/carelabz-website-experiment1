...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs Switzerland",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and NIN (SEV 1000) compliance for Switzerland facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/ch/blogs/",
    languages: {
      "en-CH": "https://carelabz.com/ch/blogs/",
      "x-default": "https://carelabz.com/ch/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs Switzerland",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Switzerland.",
    url: "https://carelabz.com/ch/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
export default async function CHBlogIndexPage() {
  const allPosts = await getBlogPosts("ch");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/ch/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs Switzerland",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Switzerland.",
      "en-CH"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/ch/" },
      { name: "Blog", url: "https://carelabz.com/ch/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of NIN (SEV 1000), NIN, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help Switzerland
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your Switzerland facility meet
              NIN (SEV 1000) and NIN requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/ch/services/arc-flash-study/"
