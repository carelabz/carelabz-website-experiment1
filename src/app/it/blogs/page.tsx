...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs Italy",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and CEI 64-8 compliance for Italy facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/it/blogs/",
    languages: {
      "en-IT": "https://carelabz.com/it/blogs/",
      "x-default": "https://carelabz.com/it/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs Italy",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Italy.",
    url: "https://carelabz.com/it/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
function formatDateShort(dateString: string | null): string {
  ...
  try {
    return new Date(dateString).toLocaleDateString("en-IT", {
      day: "numeric",
      month: "short",
      year: "numeric",
    });
...
export default async function ITBlogIndexPage() {
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/it/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs Italy",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Italy.",
      "en-IT"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/it/" },
      { name: "Blog", url: "https://carelabz.com/it/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of CEI 64-8, CEI 64-8, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help Italy
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your Italy facility meet
              CEI 64-8 and CEI 64-8 requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/it/services/arc-flash-study/"
