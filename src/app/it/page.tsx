...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("it");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | Italy",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, CEI 64-8 compliance, short circuit analysis, and power system engineering across Italy.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/it/",
      languages: {
        "en-IT": "https://carelabz.com/it/",
        "x-default": "https://carelabz.com/it/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs Italy — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, CEI 64-8 compliance, and power system engineering across Italy.",
      url: "https://carelabz.com/it/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_IT",
    },
...
export default async function ITHomePage() {
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, Italy",
    },
  };
      ...
      <section className="bg-[#EEF4FF] py-16 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-[#374151] max-w-3xl mx-auto">
            At Carelabs, we understand the importance of identifying risks and mitigating them to enhance the performance and safety of your power system and your people. We are committed to ensuring that your power system is compliant with Italy standards of electrical safety by integrating technical expertise with high-end tools like ETAP.
          </p>
        </div>
      </section>
