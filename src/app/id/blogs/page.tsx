...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs Indonesia",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and PUIL 2011 compliance for Indonesia facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/id/blogs/",
    languages: {
      "en-ID": "https://carelabz.com/id/blogs/",
      "x-default": "https://carelabz.com/id/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs Indonesia",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Indonesia.",
    url: "https://carelabz.com/id/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
export default async function IDBlogIndexPage() {
  ...
  const jsonLd = buildJsonLd([
    getRegionOrganizationSchema({ cc: "id", countryName: "Indonesia", countryIso2: "ID", phone: config.phone, email: config.email, addressLocality: config.address }),
    getWebPageSchema(
      "https://carelabz.com/id/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs Indonesia",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Indonesia.",
      "en-ID"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/id/" },
      { name: "Blog", url: "https://carelabz.com/id/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of PUIL 2011, PUIL 2011, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help Indonesian
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your Indonesia facility meet
              PUIL 2011 and PUIL 2011 requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/id/services/arc-flash-study/"
