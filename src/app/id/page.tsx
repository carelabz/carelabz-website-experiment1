...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("id");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | Indonesia",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, PUIL 2011 compliance, short circuit analysis, and power system engineering across Indonesia.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/id/",
      languages: {
        "en-ID": "https://carelabz.com/id/",
        "x-default": "https://carelabz.com/id/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs Indonesia — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, PUIL 2011 compliance, and power system engineering across Indonesia.",
      url: "https://carelabz.com/id/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_ID",
    },
...
export default async function IDHomePage() {
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, Indonesia",
    },
  };
      ...
      <section className="bg-[#EEF4FF] py-16 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-[#374151] max-w-3xl mx-auto">
            At Carelabs, we understand the importance of identifying risks and mitigating them to enhance the performance and safety of your power system and your people. We are committed to ensuring that your power system is compliant with Indonesian standards of electrical safety by integrating technical expertise with high-end tools like ETAP.
          </p>
        </div>
      </section>
