...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs Saudi Arabia",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and SBC 401 compliance for Saudi Arabia facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/sa/blogs/",
    languages: {
      "en-SA": "https://carelabz.com/sa/blogs/",
      "x-default": "https://carelabz.com/sa/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs Saudi Arabia",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Saudi Arabia.",
    url: "https://carelabz.com/sa/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
export default async function SABlogIndexPage() {
  const allPosts = await getBlogPosts("sa");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/sa/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs Saudi Arabia",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Saudi Arabia.",
      "en-SA"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/sa/" },
      { name: "Blog", url: "https://carelabz.com/sa/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of SBC 401, SBC 401, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help Saudi Arabian
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your Saudi Arabia facility meet
              SBC 401 and SBC 401 requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/sa/services/arc-flash-study/"
