...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("sa");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | Saudi Arabia",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, SBC 401 compliance, short circuit analysis, and power system engineering across Saudi Arabia.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/sa/",
      languages: {
        "en-SA": "https://carelabz.com/sa/",
        "x-default": "https://carelabz.com/sa/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs Saudi Arabia — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, SBC 401 compliance, and power system engineering across Saudi Arabia.",
      url: "https://carelabz.com/sa/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_SA",
    },
...
export default async function SAHomePage() {
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, Saudi Arabia",
    },
  };
      ...
      <section className="bg-[#EEF4FF] py-16 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-[#374151] max-w-3xl mx-auto">
            At Carelabs, we understand the importance of identifying risks and mitigating them to enhance the performance and safety of your power system and your people. We are committed to ensuring that your power system is compliant with Saudi Arabian standards of electrical safety by integrating technical expertise with high-end tools like ETAP.
          </p>
        </div>
      </section>
