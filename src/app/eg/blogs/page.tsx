...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs Egypt",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and Egyptian Code for Electrical Installations compliance for Egypt facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/eg/blogs/",
    languages: {
      "en-EG": "https://carelabz.com/eg/blogs/",
      "x-default": "https://carelabz.com/eg/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs Egypt",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Egypt.",
    url: "https://carelabz.com/eg/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
export default async function EGBlogIndexPage() {
  const allPosts = await getBlogPosts("eg");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/eg/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs Egypt",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Egypt.",
      "en-EG"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/eg/" },
      { name: "Blog", url: "https://carelabz.com/eg/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of Egyptian Code for Electrical Installations, ECP, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help Egypt
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your Egypt facility meet
              Egyptian Code for Electrical Installations and ECP requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/eg/services/arc-flash-study/"
