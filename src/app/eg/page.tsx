...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("eg");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | Egypt",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, Egyptian Code for Electrical Installations compliance, short circuit analysis, and power system engineering across Egypt.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/eg/",
      languages: {
        "en-EG": "https://carelabz.com/eg/",
        "x-default": "https://carelabz.com/eg/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs Egypt — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, Egyptian Code for Electrical Installations compliance, and power system engineering across Egypt.",
      url: "https://carelabz.com/eg/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_EG",
    },
...
export default async function EGHomePage() {
  const page = await getHomePage("eg");
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, Egypt",
    },
  };
      ...
      <section className="bg-[#EEF4FF] py-16 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-[#374151] max-w-3xl mx-auto">
            At Carelabs, we understand the importance of identifying risks and mitigating them to enhance the performance and safety of your power system and your people. We are committed to ensuring that your power system is compliant with Egypt standards of electrical safety by integrating technical expertise with high-end tools like ETAP.
          </p>
        </div>
      </section>
