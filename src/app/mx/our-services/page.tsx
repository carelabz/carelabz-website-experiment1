...
export const metadata: Metadata = {
  ...
  description:
    "Discover Carelabs' Mexican electrical safety services — arc flash studies, short circuit analysis, load flow analysis, and relay coordination aligned with NOM-029-STPS-2011 and the Mexican Electrical Code (NOM-001-SEDE).",
  alternates: {
    canonical: "https://carelabz.com/mx/our-services/",
    languages: {
      "en-MX": "https://carelabz.com/mx/our-services/",
      "x-default": "https://carelabz.com/mx/our-services/",
    },
  },
  openGraph: {
    ...
    url: "https://carelabz.com/mx/our-services/",
    siteName: "Carelabs",
    type: "website",
    locale: "en_MX",
  },
...
function getServiceHref(service: ServicePage): string {
  const slug = service.slug.endsWith("-mx")
...
export default async function MXServicesIndexPage() {
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/mx/our-services/",
    ...
    getBreadcrumbSchema([
      ...
      { name: "Services", url: "https://carelabz.com/mx/our-services/" },
    ]),
  ]);
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            <p className="text-sm font-semibold uppercase tracking-widest text-orange-400 mb-3">
              Mexican Electrical Engineering
            </p>
            ...
            <p className="text-lg text-[#374151] leading-relaxed">
              ...
              facilities compliant with NOM-029-STPS-2011 and the Mexican Electrical
              Code (NOM-001-SEDE), your workers protected, and your operations running
              smoothly — delivered by certified engineers across Mexico.
            </p>
          </div>
        </div>
      </section>
