...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs Singapore",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and SS 638 compliance for Singapore facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/sg/blogs/",
    languages: {
      "en-SG": "https://carelabz.com/sg/blogs/",
      "x-default": "https://carelabz.com/sg/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs Singapore",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Singapore.",
    url: "https://carelabz.com/sg/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
export default async function SGBlogIndexPage() {
  const allPosts = await getBlogPosts("sg");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/sg/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs Singapore",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Singapore.",
      "en-SG"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/sg/" },
      { name: "Blog", url: "https://carelabz.com/sg/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of SS 638, SS 638, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help Singapore
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your Singapore facility meet
              SS 638 and SS 638 requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/sg/services/arc-flash-study/"
