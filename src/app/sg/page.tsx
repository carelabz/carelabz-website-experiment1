...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("sg");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | Singapore",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, SS 638 compliance, short circuit analysis, and power system engineering across Singapore.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/sg/",
      languages: {
        "en-SG": "https://carelabz.com/sg/",
        "x-default": "https://carelabz.com/sg/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs Singapore — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, SS 638 compliance, and power system engineering across Singapore.",
      url: "https://carelabz.com/sg/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_SG",
    },
...
export default async function SGHomePage() {
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, Singapore",
    },
  };
      ...
      <section className="bg-[#EEF4FF] py-16 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-[#374151] max-w-3xl mx-auto">
            At Carelabs, we understand the importance of identifying risks and mitigating them to enhance the performance and safety of your power system and your people. We are committed to ensuring that your power system is compliant with Singapore standards of electrical safety by integrating technical expertise with high-end tools like ETAP.
          </p>
        </div>
      </section>
