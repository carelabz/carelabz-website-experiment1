...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs Thailand",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and EIT Standard 2001-56 compliance for Thailand facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/th/blogs/",
    languages: {
      "en-TH": "https://carelabz.com/th/blogs/",
      "x-default": "https://carelabz.com/th/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs Thailand",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Thailand.",
    url: "https://carelabz.com/th/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
export default async function THBlogIndexPage() {
  const allPosts = await getBlogPosts("th");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/th/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs Thailand",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Thailand.",
      "en-TH"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/th/" },
      { name: "Blog", url: "https://carelabz.com/th/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of EIT Standard 2001-56, EIT, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help Thailand
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your Thailand facility meet
              EIT Standard 2001-56 and EIT requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/th/services/arc-flash-study/"
