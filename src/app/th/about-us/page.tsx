...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getAboutPage("th");
  return {
    title: page?.metaTitle ?? "About Carelabs | Thailand Electrical Safety Experts",
    description:
      page?.metaDescription ??
      "Learn about Carelabs — our mission, values, and the team dedicated to electrical safety testing and EIT Standard 2001-56 compliance across Thailand.",
    alternates: {
      canonical: "https://carelabz.com/th/about-us/",
      languages: {
        "en-TH": "https://carelabz.com/th/about-us/",
        "x-default": "https://carelabz.com/th/about-us/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "About Carelabs — Power System Consultants Thailand",
      description:
        page?.metaDescription ?? "Carelabs is a leading electrical safety engineering firm in Thailand.",
      url: "https://carelabz.com/th/about-us/",
      siteName: "Carelabs",
      type: "website",
    },
    twitter: {
...
export default async function THAboutPage() {
  ...
  const subtext =
    page?.heroSubtext ??
    "Carelabs is a trusted partner for electrical safety testing, calibration, inspection, and certification services across Thailand.";
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/th/about-us/",
      page?.metaTitle ?? "About Carelabs — Power System Consultants Thailand",
      page?.metaDescription ?? "Carelabs is a leading electrical safety engineering firm in Thailand.",
      "en-TH"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/th/" },
      { name: "About", url: "https://carelabz.com/th/about-us/" },
    ]),
  ]);
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              {page?.ctaBannerHeading ?? "Partner with Carelabs Thailand"}
            </h2>
            {page?.ctaBannerSubtext ? (
              <p className="text-white/70 text-lg mb-8">{page.ctaBannerSubtext}</p>
            ) : (
              <p className="text-white/70 text-lg mb-8">
                Ready to elevate your safety standards? Talk to our Thailand experts today.
              </p>
            )}
            <Link
              href={page?.ctaBannerPrimaryHref ?? "/th/contact-us/"}
