...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("th");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | Thailand",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, EIT Standard 2001-56 compliance, short circuit analysis, and power system engineering across Thailand.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/th/",
      languages: {
        "en-TH": "https://carelabz.com/th/",
        "x-default": "https://carelabz.com/th/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs Thailand — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, EIT Standard 2001-56 compliance, and power system engineering across Thailand.",
      url: "https://carelabz.com/th/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_TH",
    },
...
export default async function THHomePage() {
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, Thailand",
    },
  };
