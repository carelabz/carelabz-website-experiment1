...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("no");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | Norway",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, NEK 400 compliance, short circuit analysis, and power system engineering across Norway.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/no/",
      languages: {
        "en-NO": "https://carelabz.com/no/",
        "x-default": "https://carelabz.com/no/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs Norway — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, NEK 400 compliance, and power system engineering across Norway.",
      url: "https://carelabz.com/no/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_NO",
    },
...
export default async function NOHomePage() {
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, Norway",
    },
  };
