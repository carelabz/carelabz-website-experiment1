...
const config = COUNTRY_CONFIGS["no"];
...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs Norway",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and NEK 400 compliance for Norway facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/no/blogs/",
    languages: {
      "en-NO": "https://carelabz.com/no/blogs/",
      "x-default": "https://carelabz.com/no/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs Norway",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Norway.",
    url: "https://carelabz.com/no/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
function formatDateShort(dateString: string | null): string {
  ...
  try {
    return new Date(dateString).toLocaleDateString("en-NO", {
      day: "numeric",
      month: "short",
      year: "numeric",
    });
...
export default async function NOBlogIndexPage() {
  const allPosts = await getBlogPosts("no");
  ...
  const jsonLd = buildJsonLd([
    getRegionOrganizationSchema({ cc: "no", countryName: "Norway", countryIso2: "NO", phone: config.phone, email: config.email, addressLocality: config.address }),
    getWebPageSchema(
      "https://carelabz.com/no/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs Norway",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Norway.",
      "en-NO"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/no/" },
      { name: "Blog", url: "https://carelabz.com/no/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of NEK 400, NEK 400, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help Norway
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your Norway facility meet
              NEK 400 and NEK 400 requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/no/services/arc-flash-study/"
