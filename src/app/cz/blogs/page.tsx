...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs Czech Republic",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and ČSN 33 2000 compliance for Czech Republic facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/cz/blogs/",
    languages: {
      "en-CZ": "https://carelabz.com/cz/blogs/",
      "x-default": "https://carelabz.com/cz/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs Czech Republic",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Czech Republic.",
    url: "https://carelabz.com/cz/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
function formatDateShort(dateString: string | null): string {
  ...
  try {
    return new Date(dateString).toLocaleDateString("en-CZ", {
      day: "numeric",
      month: "short",
      year: "numeric",
    });
...
export default async function CZBlogIndexPage() {
  const allPosts = await getBlogPosts("cz");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/cz/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs Czech Republic",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Czech Republic.",
      "en-CZ"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/cz/" },
      { name: "Blog", url: "https://carelabz.com/cz/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of ČSN 33 2000, ČSN 33 2000, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help Czech Republic
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your Czech Republic facility meet
              ČSN 33 2000 and ČSN 33 2000 requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/cz/services/arc-flash-study/"
