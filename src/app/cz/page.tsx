...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("cz");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | Czech Republic",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, ČSN 33 2000 compliance, short circuit analysis, and power system engineering across Czech Republic.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/cz/",
      languages: {
        "en-CZ": "https://carelabz.com/cz/",
        "x-default": "https://carelabz.com/cz/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs Czech Republic — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, ČSN 33 2000 compliance, and power system engineering across Czech Republic.",
      url: "https://carelabz.com/cz/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_CZ",
    },
...
export default async function CZHomePage() {
  const page = await getHomePage("cz");
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, Czech Republic",
    },
  };
      ...
      <section className="bg-[#EEF4FF] py-16 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-[#374151] max-w-3xl mx-auto">
            At Carelabs, we understand the importance of identifying risks and mitigating them to enhance the performance and safety of your power system and your people. We are committed to ensuring that your power system is compliant with Czech Republic standards of electrical safety by integrating technical expertise with high-end tools like ETAP.
          </p>
        </div>
      </section>
