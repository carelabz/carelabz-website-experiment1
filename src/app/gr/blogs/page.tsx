...
export const metadata: Metadata = {
  title: "Electrical Safety Blog: Power System Studies & Analysis | Carelabs Greece",
  description:
    "Expert insights on electrical safety, power system studies, arc flash analysis, and ELOT HD 384 compliance for Greece facilities. Stay informed with Carelabs.",
  alternates: {
    canonical: "https://carelabz.com/gr/blogs/",
    languages: {
      "en-GR": "https://carelabz.com/gr/blogs/",
      "x-default": "https://carelabz.com/gr/blogs/",
    },
  },
  openGraph: {
    title: "Electrical Safety Blog & Industry Insights | Carelabs Greece",
    description:
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Greece.",
    url: "https://carelabz.com/gr/blogs/",
    siteName: "Carelabs",
    type: "website",
  },
  twitter: {
...
function formatDateShort(dateString: string | null): string {
  ...
  try {
    return new Date(dateString).toLocaleDateString("en-GR", {
      day: "numeric",
      month: "short",
      year: "numeric",
    });
...
export default async function GRBlogIndexPage() {
  const allPosts = await getBlogPosts("gr");
  ...
  const jsonLd = buildJsonLd([
    ...
    getWebPageSchema(
      "https://carelabz.com/gr/blogs/",
      "Electrical Safety Blog & Industry Insights | Carelabs Greece",
      "Expert insights on arc flash analysis, power system engineering, and electrical safety compliance in Greece.",
      "en-GR"
    ),
    getBreadcrumbSchema([
      { name: "Home", url: "https://carelabz.com/gr/" },
      { name: "Blog", url: "https://carelabz.com/gr/blogs/" },
    ]),
  ]);
        ...
        <section className="bg-[#EEF4FF] pt-32 pb-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-[#374151] max-w-2xl mx-auto">
              Stay ahead of ELOT HD 384, ELOT HD 384, and IEEE 1584 requirements.
              Expert knowledge from the Carelabs engineering team to help Greece
        ...
        <section className="bg-[#0050B3] py-20 px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Our expert engineers are ready to help your Greece facility meet
              ELOT HD 384 and ELOT HD 384 requirements. Get a free consultation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/gr/services/arc-flash-study/"
