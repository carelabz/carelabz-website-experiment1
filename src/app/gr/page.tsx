...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHomePage("gr");
  return {
    title: page?.metaTitle ?? "Carelabs — Electrical Safety & Power System Studies | Greece",
    description:
      page?.metaDescription ??
      "Carelabs provides IEEE 1584 arc flash studies, ELOT HD 384 compliance, short circuit analysis, and power system engineering across Greece.",
    keywords: page?.seoKeywords ?? undefined,
    alternates: {
      canonical: "https://carelabz.com/gr/",
      languages: {
        "en-GR": "https://carelabz.com/gr/",
        "x-default": "https://carelabz.com/gr/",
      },
    },
    openGraph: {
      title: page?.metaTitle ?? "Carelabs Greece — Electrical Safety & Power System Studies",
      description:
        page?.metaDescription ?? "IEEE 1584 arc flash studies, ELOT HD 384 compliance, and power system engineering across Greece.",
      url: "https://carelabz.com/gr/",
      siteName: "Carelabs",
      type: "website",
      locale: "en_GR",
    },
...
export default async function GRHomePage() {
  ...
  const jsonLdData = {
    ...
    address: {
      "@type": "PostalAddress",
      addressLocality: page.footerAddress ?? "Toronto, ON, Greece",
    },
  };
      ...
      <section className="bg-[#EEF4FF] py-16 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-[#374151] max-w-3xl mx-auto">
            At Carelabs, we understand the importance of identifying risks and mitigating them to enhance the performance and safety of your power system and your people. We are committed to ensuring that your power system is compliant with Greece standards of electrical safety by integrating technical expertise with high-end tools like ETAP.
          </p>
        </div>
      </section>
